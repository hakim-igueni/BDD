// 1. Distance et durée entre deux villes (ex : Toronto et Vancouver)
...
// 2. Villes à moins de 10 km d’une ville donnée (ex : Montreal)
...
// 9. Itinéraire optimal par distance entre deux villes (ex : Ottawa → Vancouver)
MATCH
  path =
